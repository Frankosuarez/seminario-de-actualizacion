...
void MenuCliente(Producto productos[]){
    int opcion;
    do{
...
void VerificarUsuario(Usuario usuario[],Producto productos[]) {
    ...
    if(usuario[i].Contraseña == contraseña){
        ...
        if(usuario[i].Categoria == "Cliente"){
        MenuCliente(productos);
        return;
        };

        if(usuario[i].Categoria == "Administrador"){
            MenuSistema(usuario,productos);
            return;
        }

        if(usuario[i].Categoria == "Deposito");{
            MenuProductos(productos);
            return;
        }

        if(usuario[i].Categoria == "Vendedor");{
            MenuProductos(productos);
            return;
        }
